...
import { LayoutDashboard, Briefcase, FilePlus2, CalendarCheck2, ClipboardList, UserCircle, Settings, LayoutList, Archive } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/templates', label: 'Manage Templates', icon: LayoutList },
